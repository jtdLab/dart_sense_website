...
const PricingCard = (props: Pricing) => {
  return (
    <div className="w-[350px] sm:w-[380px] lg:w-3/10 px-4 mb-8">
      ...
      >
        <div className="h-full p-8 bg-dartsenseBg3 rounded-3xl">
          ...
          <a
            target="_blank"
            href={props.cta.link}
            className="inline-block text-center py-2 px-4 w-full rounded-xl rounded-t-xl dartsense-button-colored font-bold leading-loose mt-8"
          >
            {props.cta.title}
          </a>
        </div>
...
export const Pricing = () => {
  return (
    <section className="w-screen flex justify-center bg-dartsenseBg2 relative">
      <div className="absolute -top-16" id="pricing" />
      <div className="pb-20 pt-12 bg-dartsenseBg2  2xl:w-[1150px] lg:w-[1050px]  md:w-4/5 ">
        <motion.div
          initial={{ opacity: 0 }}
